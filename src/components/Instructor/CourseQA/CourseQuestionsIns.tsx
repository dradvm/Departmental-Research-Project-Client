...
import QuestionItem from "components/Course/CourseDetails/CourseQA/Question/QuestionItem";
...
export default function CourseQuestions({
  ...
  const { courseId: contextCourseId, lectureId, lectures } = useLearnContext();

  const realCourseId = forceCourseId || contextCourseId;
  const realQuestionSelect = forceAllLectures ? true : questionSelect;
  ...
  const loadQuestions = useCallback(() => {
    ...
    if (realQuestionSelect) {
      qaService
        .getQuestions(
          parseInt(realCourseId),
          questionOrderBy,
          searchValue,
          isUser,
          isNone,
