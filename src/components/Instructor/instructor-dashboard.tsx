        ...
        <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-100 p-4 rounded-md border flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <span className="font-semibold">We upgraded practice tests so you can upgrade yours.</span>
                    <p className="text-sm text-gray-600 mt-1">
                        With our creation improvements, new question types, and generative AI features...
                    </p>
                </div>
                <div className="flex gap-2">
                    <button className="bg-purple-600 text-white px-4 py-1 rounded-md text-sm">Learn more</button>
                    <button className="text-sm text-gray-700">Dismiss</button>
                </div>
            </div>
